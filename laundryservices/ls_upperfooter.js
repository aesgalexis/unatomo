    ...
    <section class="ls-upperfooter" aria-label="Laundry Services upperfooter">
      ...
      <div class="ls-upperfooter-col ls-upperfooter-col-main">
        ...
        <ul class="ls-upperfooter-list">
          <li data-i18n="card1_title">Auditoria tecnica y de procesos</li>
          <li data-i18n="card2_title">Asesoria independiente de equipamiento</li>
      ...
      <div class="ls-upperfooter-col ls-upperfooter-contact">
        <div class="contact-info">
          <div class="contact-info-item">
            ...
            <p>
              <strong data-i18n="contact_email_label">Correo electrÃ³nico:</strong>
          ...
          <div class="contact-info-item">
            ...
            <p>
              <strong data-i18n="contact_phone_label">TelÃ©fono:</strong>
          ...
          <div class="contact-info-item">
            ...
            <p>
              <strong data-i18n="contact_hours_label">Horario de atenciÃ³n:</strong>
              <span data-i18n="contact_hours_value">De lunes a viernes, de 09:00 a 15:00 (Horario de EspaÃ±a / CET).</span>
            </p>
          </div>
          ...
          <div class="contact-info-item">
            ...
            <p>
              <strong data-i18n="contact_address_label">DirecciÃ³n:</strong>
              CL. Lluna 2 1, 07440 Muro, Mallorca, EspaÃ±a
            </p>
          </div>
        </div>
      </div>
