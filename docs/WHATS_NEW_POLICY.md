...
Authoritative toggle: `static/data/codex-flags.json`.
...
The control panel card can show or locally pause the preference in the browser, but Codex must treat `static/data/codex-flags.json` as the source of truth during code work.
