(() => {
  ...
  const I18N = {
    es: {
      ...
      about_link: "Nosotros",
      nfc_link: "NFC",
      nfc_product_link: "UNATOMO/NFC para la gestión digital de máquinas",
    ...
    en: {
      ...
      about_link: "About us",
      nfc_link: "NFC",
      nfc_product_link: "UNATOMO/NFC for digital machine management",
    ...
    it: {
      ...
      nfc_link: "NFC",
      nfc_product_link: "UNATOMO/NFC per la gestione digitale delle macchine",
    ...
    el: {
      ...
      nfc_link: "NFC",
      nfc_product_link: "UNATOMO/NFC για την ψηφιακή διαχείριση μηχανών",
