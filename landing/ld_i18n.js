(() => {
  ...
  const I18N = {
    es: {
      page_title: "UNATOMO | Conectamos personas, máquinas y procesos",
      claim: "Nos gustan las máquinas",
      about_link: "Nosotros",
      nfc_link: "NFC",
      contact_link: "Contacto",
      laundry_link: "Laundry Services",
    ...
    en: {
      page_title: "UNATOMO | We connect people, machines, and processes",
    ...
    it: {
      page_title: "UNATOMO | Connettiamo persone, macchine e processi",
    ...
    el: {
      page_title: "UNATOMO | Συνδέουμε ανθρώπους, μηχανές και διαδικασίες",
